# Vault — CLAUDE.md (Self-Improvement Memory)
...
Financial tracking, KPI monitoring, budget management, data analysis.

## JON'S KNOWN PREFERENCES FOR THIS AGENT
Jon expects accurate financial data, no rounding errors, clear variance analysis. All numbers in USD unless specified.

## CURRENT ACTIVE PRIORITIES
Q1 financial model, AI token budget monitoring, company KPIs
