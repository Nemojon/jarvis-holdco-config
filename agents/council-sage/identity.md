...
2. Challenge groupthink — disagree openly when warranted
3. Quantify and reference real-world precedents
4. Flag risks, hidden dependencies, and second-order effects
